...
const InspectiontestsAdd = (props) => {
    ...
    const onFormSubmit = async (formData) => {
        ...
        toast.promise(createInspectiontest({
                ...
                .unwrap(), {
                    pending: `Adding a Inspectiontest `,
                    success: `Successfully added Inspectiontest `,
                    error: `Could not add Inspectiontest `,
    ...
    if (redirectToList) {
        return (<Navigate to={`/inspectiontest`} replace={false}/>)
    }
