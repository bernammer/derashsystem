...
import {useLazyGetInspectiontestQuery, useUpdateInspectiontestMutation} from "./inspectiontestsSlice"
...
const InspectiontestsListDetail = ({}) => {
    ...
    if (inspectiontestResult.isSuccess) {
        console.log(inspectiontestResult)
        return (
            <>
                    ...
                    <form className="row p-3" onSubmit={handleSubmit(onFormSubmit)}>
                        <div className="grid grid-cols-2 gap-x-5">
                            ...
                            <div
                                ...
                                <input
                                    id="vehicle"
                                    className="form-input w-full ml-2 disabled:bg-slate-50"
                                    type="text"
                                    disabled={true}
                                    defaultValue={inspectiontestResult.data.inspectiontest.vehicle.plate ?? '-'}
                                    name="vehicle"
                                    {...register('vehicle', {
                            ...
                            <div
                                ...
                                <input
                                    ...
                                    type="text"
                                    disabled={true}
                                    defaultValue={inspectiontestResult.data.inspectiontest.user.firstName ?? '-'}
                                    name="user"
                                    {...register('user', {
                            ...
                            <div
                                ...
                                <label
                                    ...
                                    Brake Test - Front <span className="text-rose-500">*</span>
                                </label>
                                <input
                                    id="brakeFrontAxleLeft"
                                    className="form-input w-full ml-2 "
                                    type="text"
                                    defaultValue={inspectiontestResult.data.inspectiontest.axleLoad.frontAxlePassFail ?? '-'}
                                    name="brakeFrontAxleLeft"
                                    {...register('brakeFrontAxleLeftwesd', {
                                            required: {value: true, message: "Brake Front Axle Left  is required"},

                                        }
                                    )}
                                />
                                {errors.brakeFrontAxleLeft && <p className={`ml-2 mt-1 text-red-600`}>
                                    <span>{errors.brakeFrontAxleLeft.message}</span></p>}
                            </div>
                            <div
                                className="pb-5">
                                <label
                                    className="block text-sm font-medium mb-1"
                                    htmlFor="brakeFrontAxleLeft">
                                    Brake Test - Rear <span className="text-rose-500">*</span>
                                </label>
                                <input
                                    id="brakeFrontAxleLeft"
                                    className="form-input w-full ml-2 "
                                    type="text"
                                    defaultValue={inspectiontestResult.data.inspectiontest.axleLoad.rearAxlePassFail ?? '-'}
                                    name="brakeRearAxleLeft"
                                    {...register('brakeFrontAxleLefthtrewes', {
                                            required: {value: true, message: "Brake Front Axle Left  is required"},
                            ...
                            <div
                                ...
                                <label
                                    className="block text-sm font-medium mb-1"
                                    htmlFor="brakeFrontAxleLeft">
                                    Brake Difference Test - Front <span className="text-rose-500">*</span>
                                </label>
                                <input
                                    id="brakeFrontAxleLeft"
                                    className="form-input w-full ml-2 "
                                    type="text"
                                    defaultValue={inspectiontestResult.data.inspectiontest.brakeDifference.frontAxlePassFail ?? '-'}
                                    name="brakeFrontAxleLeft"
                                    {...register('brakeFrontAxleLew3weft', {
                                            required: {value: true, message: "Brake Front Axle Left  is required"},
                            ...
                            <div
                                ...
                                <label
                                    className="block text-sm font-medium mb-1"
                                    htmlFor="brakeFrontAxleLeft">
                                    Brake Difference Test - Rear <span className="text-rose-500">*</span>
                                </label>
                                <input
                                    id="brakeFrontAxleLeft"
                                    className="form-input w-full ml-2 "
                                    type="text"
                                    defaultValue={inspectiontestResult.data.inspectiontest.brakeDifference.rearAxlePassFail ?? '-'}
                                    name="brakeRearAxleLeft"
                                    {...register('brakeFrontAxw2wedleLeft', {
                                            required: {value: true, message: "Brake Front Axle Left  is required"},
                            ...
                            <div
                                ...
                                <label
                                    className="block text-sm font-medium mb-1"
                                    htmlFor="brakeFrontAxleLeft">
                                    Suspension Difference Test - Front <span className="text-rose-500">*</span>
                                </label>
                                <input
                                    id="brakeFrontAxleLeft"
                                    className="form-input w-full ml-2 "
                                    type="text"
                                    defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifference.frontAxlePassFail ?? '-'}
                                    name="brakeFrontAxleLeft"
                                    {...register('brakeFrontAxleLew3weft', {
                                            required: {value: true, message: "Brake Front Axle Left  is required"},
                            ...
                            <div
                                ...
                                <label
                                    className="block text-sm font-medium mb-1"
                                    htmlFor="brakeFrontAxleLeft">
                                    Suspension Difference Test - Rear <span className="text-rose-500">*</span>
                                </label>
                                <input
                                    id="brakeFrontAxleLeft"
                                    className="form-input w-full ml-2 "
                                    type="text"
                                    defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifference.rearAxlePassFail ?? '-'}
                                    name="brakeRearAxleLeft"
                                    {...register('brakeFrontAxw2wedleLeft', {
                                            required: {value: true, message: "Brake Front Axle Left  is required"},
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeRearAxleLeft ?? '-'}*/}
                            {/*        name="brakeRearAxleLeft"*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.brakeRearAxleLeft && <p className={`ml-2 mt-1 text-red-600`}>*/}
                            {/*        <span>{errors.brakeRearAxleLeft.message}</span></p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeRearAxleRight ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.brakeRearAxleRight && <p className={`ml-2 mt-1 text-red-600`}>*/}
                            {/*        <span>{errors.brakeRearAxleRight.message}</span></p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceFrontAxlePassFail ?? '-'}*/}
                            {/*        name="parkingForceFrontAxlePassFail"*/}
                            {/*        {...register('parkingForceFrontAxlePassFail', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Parking Force Front Axle Pass Fail  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceFrontAxleStandard ?? '-'}*/}
                            {/*        name="parkingForceFrontAxleStandard"*/}
                            {/*        {...register('parkingForceFrontAxleStandard', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Parking Force Front Axle Standard  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceRearAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceRearAxlePassFail ?? '-'}*/}
                            {/*        name="parkingForceRearAxlePassFail"*/}
                            {/*        {...register('parkingForceRearAxlePassFail', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Parking Force Rear Axle Pass Fail  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingForceRearAxleStandard ?? '-'}*/}
                            {/*        name="parkingForceRearAxleStandard"*/}
                            {/*        {...register('parkingForceRearAxleStandard', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Parking Force Rear Axle Standard  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadRearAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleLoadRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.axleloadRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyFrontAxleLeft ?? '-'}*/}
                            {/*        name="brakeEfficiencyFrontAxleLeft"*/}
                            {/*        {...register('brakeEfficiencyFrontAxleLeft', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Efficiency Front Axle Left  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyFrontAxleRight ?? '-'}*/}
                            {/*        name="brakeEfficiencyFrontAxleRight"*/}
                            {/*        {...register('brakeEfficiencyFrontAxleRight', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Efficiency Front Axle Right  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyfrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyRearAxleLeft ?? '-'}*/}
                            {/*        name="brakeEfficiencyRearAxleLeft"*/}
                            {/*        {...register('brakeEfficiencyRearAxleLeft', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Efficiency Rear Axle Left  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyRearAxleRight ?? '-'}*/}
                            {/*        name="brakeEfficiencyRearAxleRight"*/}
                            {/*        {...register('brakeEfficiencyRearAxleRight', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Efficiency Rear Axle Right  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeEfficiencyRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceFrontAxleLeft ?? '-'}*/}
                            {/*        name="brakeDifferenceFrontAxleLeft"*/}
                            {/*        {...register('brakeDifferenceFrontAxleLeft', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Difference Front Axle Left  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceFrontAxleRight ?? '-'}*/}
                            {/*        name="brakeDifferenceFrontAxleRight"*/}
                            {/*        {...register('brakeDifferenceFrontAxleRight', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Difference Front Axle Right  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceRearAxleLeft ?? '-'}*/}
                            {/*        name="brakeDifferenceRearAxleLeft"*/}
                            {/*        {...register('brakeDifferenceRearAxleLeft', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Difference Rear Axle Left  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceRearAxleRight ?? '-'}*/}
                            {/*        name="brakeDifferenceRearAxleRight"*/}
                            {/*        {...register('brakeDifferenceRearAxleRight', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "Brake Difference Rear Axle Right  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.brakeDifferenceRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        Parking Brake Efficiency Front Axle Pass Fail <span*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeEfficiencyFrontAxlePassFail &&*/}
                            ...
                            {/*        Parking Brake Efficiency Front Axle Standard <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeEfficiencyFrontAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyRearAxleRight ?? '-'}*/}
                            ...
                            {/*        Parking Brake Efficiency Rear Axle Pass Fail <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeEfficiencyRearAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeEfficiencyRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeEfficiencyRearAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        Parking Brake Difference Front Axle Pass Fail <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeDifferenceFrontAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        Parking Brake Difference Front Axle Standard <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeDifferenceFrontAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceRearAxleRight ?? '-'}*/}
                            ...
                            {/*        Parking Brake Difference Rear Axle Pass Fail <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeDifferenceRearAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.parkingBrakeDifferenceRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.parkingBrakeDifferenceRearAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipRearAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.sideSlipRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        Total Parking Efficiency Front Axle Pass Fail <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalParkingEfficiencyFrontAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        Total Parking Efficiency Front Axle Standard <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalParkingEfficiencyFrontAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyRearAxleRight ?? '-'}*/}
                            ...
                            {/*        Total Parking Efficiency Rear Axle Pass Fail <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalParkingEfficiencyRearAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalParkingEfficiencyRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalParkingEfficiencyRearAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalBrakeEfficiencyFrontAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalBrakeEfficiencyFrontAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyRearAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalBrakeEfficiencyRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalHandBrakeEfficiencyFrontAxleLeft &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        Total Hand Brake Efficiency Front Axle Right <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalHandBrakeEfficiencyFrontAxleRight &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        Total Hand Brake Efficiency Front Axle Standard <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyRearAxleRight ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalHandBrakeEfficiencyRearAxleRight &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        Total Hand Brake Efficiency Rear Axle Pass Fail <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalHandBrakeEfficiencyRearAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        Total Hand Brake Efficiency Rear Axle Standard <span*/}
                            {/*        className="text-rose-500">*</span>*/}
                            {/*    </label>*/}
                            {/*    <input*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.totalHandBrakeEfficiencyRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.totalHandBrakeEfficiencyRearAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.suspensionEfficiencyFrontAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.suspensionEfficiencyFrontAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyRearAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionEfficiencyRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceFrontAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceFrontAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceFrontAxlePassFail ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.suspensionDifferenceFrontAxlePassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceFrontAxleStandard ?? '-'}*/}
                            ...
                            {/*        )}*/}
                            {/*    />*/}
                            {/*    {errors.suspensionDifferenceFrontAxleStandard &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceRearAxleLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceRearAxleRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceRearAxlePassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.suspensionDifferenceRearAxleStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.highBeanIntensityLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.highBeanIntensityLeftPassFail ?? '-'}*/}
                            {/*        name="highBeanIntensityLeftPassFail"*/}
                            {/*        {...register('highBeanIntensityLeftPassFail', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "High Bean Intensity Left Pass Fail  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.highBeanIntensityLeftStandard ?? '-'}*/}
                            {/*        name="highBeanIntensityLeftStandard"*/}
                            {/*        {...register('highBeanIntensityLeftStandard', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "High Bean Intensity Left Standard  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.highBeanIntensityRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.highBeanIntensityRightPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.highBeanIntensityRightStandard ?? '-'}*/}
                            {/*        name="highBeanIntensityRightStandard"*/}
                            {/*        {...register('highBeanIntensityRightStandard', {*/}
                            {/*                required: {*/}
                            {/*                    value: true,*/}
                            {/*                    message: "High Bean Intensity Right Standard  is required"*/}
                            {/*                },*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofFarLightLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofFarLightLeftPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofFarLightLeftStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofFarLightRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofFarLightRightPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofFarLightRightStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofNearLightLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofNearLightLeftPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofNearLightLeftStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofNearLightRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofNearLightRightPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetLRofNearLightRightStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        name="left"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.left ?? '-'}*/}
                            {/*        {...register('left', {*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        name="leftPassFail"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.leftPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        name="leftStandard"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.leftStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        name="right"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.right ?? '-'}*/}
                            {/*        {...register('right', {*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        name="rightPassFail"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.rightPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        name="rightStandard"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.rightStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetUDofNearLightLeft ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetUDofNearLightLeftPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetUDofNearLightLeftStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetUDofNearLightRight ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetUDofNearLightRightPassFail ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.offsetUDofNearLightRightStandard ?? '-'}*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.hcTestMode ?? '-'}*/}
                            {/*        name="hcTestMode"*/}
                            {/*        {...register('hcTestMode', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.hcTestMode &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.hcTestMode.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.hcPassFail ?? '-'}*/}
                            {/*        name="hcPassFail"*/}
                            {/*        {...register('hcPassFail', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.hcPassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.hcPassFail.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.ocTestMode ?? '-'}*/}
                            {/*        name="ocTestMode"*/}
                            {/*        {...register('ocTestMode', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.ocTestMode &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.ocTestMode.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.ocPassFail ?? '-'}*/}
                            {/*        name="ocPassFail"*/}
                            {/*        {...register('ocPassFail', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.ocPassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.ocPassFail.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.lambdaTestMode ?? '-'}*/}
                            {/*        name="lambdaTestMode"*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.lambdaPassFail ?? '-'}*/}
                            {/*        name="lambdaPassFail"*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.co2PassFail ?? '-'}*/}
                            {/*        name="co2PassFail"*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.co2PassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.co2PassFail.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.o2TestMode ?? '-'}*/}
                            {/*        name="o2TestMode"*/}
                            {/*        {...register('o2TestMode', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.o2TestMode &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.o2TestMode.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.o2PassFail ?? '-'}*/}
                            {/*        name="o2PassFail"*/}
                            {/*        {...register('o2PassFail', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.o2PassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.o2PassFail.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.noTestMode ?? '-'}*/}
                            {/*        name="noTestMode"*/}
                            {/*        {...register('noTestMode', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.noTestMode &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.noTestMode.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                            ...
                            {/*        className="form-input w-full ml-2 "*/}
                            {/*        type="text"*/}
                            {/*        defaultValue={inspectiontestResult.data.inspectiontest.noPassFail ?? '-'}*/}
                            {/*        name="noPassFail"*/}
                            {/*        {...register('noPassFail', {*/}
                            ...
                            {/*    />*/}
                            {/*    {errors.noPassFail &&*/}
                            {/*        <p className={`ml-2 mt-1 text-red-600`}><span>{errors.noPassFail.message}</span>*/}
                            {/*        </p>}*/}
                            {/*</div>*/}
                        ...
                        <div className="flex">
                            ...
                            <button
                                className="disabled:bg-indigo-200 disabled:cursor-not-allowed disabled:text-slate-500 ml-2 mt-auto btn bg-indigo-500 hover:bg-indigo-600 text-white"
                                type="submit"
                                disabled={true}
                            >
                                <span className="hidden xs:block ml-1">Update Inspection Test </span>
                            </button>
                        </div>
                    </form>
                </div>
