...
const InspectiontestsListItem = (props) => {
    ...
    return (
        <tr key={props.react_unique_identifier_key}>
                ...
                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div className="text-left">{props.user}</div>
                                </td>
                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div className="text-left">{props.left}</div>
                                </td> {/* No chance */}
                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div className="text-left">{props.leftPassFail}</div>
                                </td> {/* No chance */}
                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div className="text-left">{props.leftStandard}</div>
                                </td> {/* No chance */}
                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
            ...
            <ModalBasic title={"Delete Inspectiontest"} id={props.id} modalOpen={deleteModal} setModalOpen={(e) => {
                setDeleteModal(false)
            }} children={
                <div className="border-t border-slate-200">
                    <div className="pb-3 px-3 pt-3">
                        <span className={`font-bold`}>{props.vehicle }</span> will be deleted! Are you sure to delete this
                        Inspectiontest?
