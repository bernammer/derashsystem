...
const InspectiontestsList = () => {
    ...
    if (isError) {
        toast.error("Could not fetch the Inspectiontest", {
                ...
                <div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="table-auto w-full">
                            ...
                            <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div className="font-semibold text-left">Left </div>
                            </th>
                            ...
                            <tbody className="text-sm divide-y divide-slate-200">
                            {
                              data['rows']?.map(listElement => {
                               ...
                               left={listElement.left}
                               leftPassFail={listElement.leftPassFail}
                               leftStandard={listElement.leftStandard}
                               right={listElement.right}
                               rightPassFail={listElement.rightPassFail}
                               rightStandard={listElement.rightStandard}
