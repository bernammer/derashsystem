        ...
        return (
            ...
            <div className="border-t border-slate-200">
                ...
                <input
                    ...
                    type="text"
                    defaultValue={employeeResult.data.name ?? '-'}
                    name="name"
                    {...register('name', {
                ...
                {errors.name && <p className={`ml-2 mt-1 text-red-600`}><span>{errors.name.message}</span></p>}
                            ...
                            className="pb-5">
                                ...
                                <input
                                    ...
                                    className="form-input w-full ml-2 "
                                     type="text"
                                     defaultValue={employeeResult.data.phone_number ?? '-'}
                                     name="phone_number"
                ...
                <input
                    ...
                    className="form-input w-full ml-2 "
                    type="text"
                    defaultValue={employeeResult.data.other_data ?? '-'}
                    name="other_data"
                    {...register('other_data', {
                ...
                />
                {errors.other_data && <p className={`ml-2 mt-1 text-red-600`}><span>{errors.other_data.message}</span></p>}
            </div>
                ...
                <input
                    ...
                    className="form-input w-full ml-2 "
                    type="text"
                    defaultValue={employeeResult.data.username ?? '-'}
                    name="username"
                    {...register('username', {
                                    ...
                                    <label className="flex text-sm font-medium mb-1" htmlFor="mandatory">
                                        ...
                                        <div className="form-switch my-full ml-1">
                                            <input 
                                                ...
                                                className="sr-only"
                                                checked={employeeResult.data.isCompanyAdmin} 
                                                onChange={async (e) => {
                                                    toggleIsCompanyAdmin({id: employeeResult.data.id})
                                                }} 
                                            />
