    ...
    useEffect(() => {
        toast.promise(
            ...
            .unwrap(), {
                ...
                success: `Fetched Insurancesticker detail successfully`,
    ...
    if (insurancestickerResult.isSuccess) {
        return (
            ...
            <div className="border-t border-slate-200">
                ...
                />
                {errors.policyNo && <p className={`ml-2 mt-1 text-red-600`}><span>{errors.policyNo.message}</span></p>}
            </div>
                ...
                <input
                    ...
                    className="form-input w-full ml-2 "
                    type="text"
                    defaultValue={insurancestickerResult.data.type ?? '-'}
                    name="type"
                    {...register('type', {
