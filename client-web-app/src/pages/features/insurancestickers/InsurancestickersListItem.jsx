...
const InsurancestickersListItem = (props) => {
    ...
    return (
        <tr key={props.react_unique_identifier_key}>
            ...
            <ModalBasic title={"Delete Insurancesticker"} id={props.id} modalOpen={deleteModal} setModalOpen={(e) => {
                setDeleteModal(false)
            }} children={
                <div className="border-t border-slate-200">
                    <div className="pb-3 px-3 pt-3">
                        <span className={`font-bold`}>{props.issuedDate }</span> will be deleted! Are you sure to delete this
                        Insurancesticker?
