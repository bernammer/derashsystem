...
const VehiclesList = () => {
    ...
    if (isError) {
        toast.error("Could not fetch the Vehicle", {
        ...
        <>
            ...
            <div className="bg-white shadow-lg rounded-sm border border-slate-200 relative">
                <header className="px-5 py-4">
                    <h2 className="font-semibold text-slate-800">Vehicles - <span
                ...
                <div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="table-auto w-full">
                            ...
                            <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div className="font-semibold text-left">Chassis Number </div>
                            </th>
                            ...
                            <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div className="font-semibold text-left">Motor Number </div>
                            </th>
                            ...
                            <tbody className="text-sm divide-y divide-slate-200">
                            {
                              data['rows']?.map(listElement => {
                               ...
                               chassisNumber={listElement.chassisNumber}
                               vehicleType={listElement.vehicleType}
                               motorNumber={listElement.motorNumber}
