                ...
                <form className="row p-3" onSubmit={handleSubmit(onFormSubmit)}>
                    ...
                    <div className="grid grid-cols-2 gap-x-5">
                        ...
                        <div
                            ...
                            />
                            {errors.plateNumber &&
                                <p className={`ml-2 mt-1 text-red-600`}><span>{errors.plateNumber.message}</span></p>}
                        </div>
                        ...
                        <div
                            ...
                            {errors.receiptNumber &&
                                <p className={`ml-2 mt-1 text-red-600`}><span>{errors.receiptNumber.message}</span></p>}
                        </div>
                        ...
                        <div
                            ...
                            {errors.examinationNumber &&
                                <p className={`ml-2 mt-1 text-red-600`}><span>{errors.examinationNumber.message}</span>
                                </p>}
                        </div>
