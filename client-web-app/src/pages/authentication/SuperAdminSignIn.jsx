            ...
            <main className="bg-white">
                ...
                <div className="relative md:flex">
                    ...
                    <div className="md:w-1/2">
                        <div className="min-h-screen h-full flex flex-col after:flex-1">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                                    ...
                                    <Link className={`flex`} to="/">
                                        {/*<img src={Bolo} className={`h-16 rounded-full`} ></img>*/}
                                        {/*<p className={`ml-5 my-auto text-[26px] text-black font-bold`}>*/}
                                        {/*    Bolo Service Provider*/}
                                        {/*</p>*/}
                            ...
                            <div className="max-w-sm mx-auto px-4 py-8">
                                <h1 className="text-3xl text-slate-800 font-bold mb-6">Welcome! Admin ✨</h1>
                                {/* Form */}
                    ...
                    <div className="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
                        <img className="object-contain object-center w-full h-full" src={AuthImage} width="760"
